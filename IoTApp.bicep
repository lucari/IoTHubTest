// 
// This will create an Function App
//

@description('Define the project name or prefix for all objects.')
@minLength(1)
@maxLength(11)
param projectName string = 'lucari'
...
@description('The runtime environment .Net')
param functionRuntime string = 'dotnet'


var functionAppName = '${projectName}FuncApp${uniqueString(resourceGroup().id)}'
var appServiceName = '${projectName}AppSvc${uniqueString(resourceGroup().id)}'
var iotHubName = '${projectName}IoTHub${uniqueString(resourceGroup().id)}'

var storageAccountName = '${toLower(projectName)}sa${uniqueString(resourceGroup().id)}'
var storageEndpoint = '${projectName}StorageEndpont'
var storageContainerName = '${toLower(projectName)}results'
var storageTableName = '${toLower(projectName)}output'
